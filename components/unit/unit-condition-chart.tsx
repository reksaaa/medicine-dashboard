...
interface UnitConditionChartProps {
  unitId: number
...
export function UnitConditionChart({ unitId, selectedMedicines }: UnitConditionChartProps) {
  ...
  return (
    <Card className="h-full unit-condition-chart">
      <CardHeader>
